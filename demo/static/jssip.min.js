  ...
  return (function () {
  ...
  })()(
    {
      ...
      3: [
        function (e, t, n) {
          ...
          var i = e("./Logger"),
            ...
            c = e("./Utils"),
            h = new i("Dialog"),
            d = { STATUS_EARLY: 1, STATUS_CONFIRMED: 2, STATUS_TERMINATED: 3 };
          t.exports = (function () {
            function e(t, n, r) {
              var s =
      ...
      4: [
            ...
            function e(t, n, r) {
              ...
              l))
                Object.prototype.hasOwnProperty.call(l, s) &&
                  (this._eventHandlers[s] || (this._eventHandlers[s] = l[s]));
            }
            var t, n, u;
            return (
              (t = e),
        ...
        { "../Constants": 2, "../RequestSender": 20, "../Transactions": 24 },
      ],
      5: [
        function (e, t, n) {
          "use strict";
                          ...
                          return new Promise(function (t) {
                            ...
                            r.addEventListener(
                              ...
                              r.addEventListener(
                                "icegatheringstatechange",
                                (i = function () {
                                  "complete" === r.iceGatheringState && l();
                                })
                              );
                          });
                        })
                    ...
                    switch (this._method) {
                      ...
                      default:
                        this.clientTransaction =
                          new l.NonInviteClientTransaction(
                            this._ua,
                            this._ua.transport,
                            this._request,
                            t
          ...
          var f = e("sdp-transform"),
            ...
            C = (function (e) {
              ...
              function n(e, r, s, i, o) {
                ...
                return (
                  c(this, n),
                  ((l = t.call(this, p.INVITE, e, r, s, i, o)).transaction =
                    null),
                  l
                );
              }
                  ...
                  },
                  {
                    ...
                    value: function () {
                      ...
                      if (
                        ...
                        var a,
                          c = u(this.ua.configuration.extra_headers);
                        try {
                          for (c.s(); !(a = c.n()).done; ) {
                            var h = a.value;
                            s += "".concat(h.trim(), "\r\n");
        ...
        function (e, t, n) {
          ...
          n.isSocket = function (e) {
            ...
            try {
              if (!s.isString(e.url))
                throw (
                  (o.warn("missing or invalid JsSIP.Socket url property"),
              ...
              if (-1 === i.parse(e.sip_uri, "SIP_URI"))
                throw (
                  (o.warn("missing or invalid JsSIP.Socket sip_uri property"),
                ...
                },
                {
                  ...
                  value: function (e) {
                    if ("\r\n\r\n" !== e)
                      ...
                      l.debug(
                        "received message with double-CRLF Keep Alive request"
                      );
                      try {
                        this.socket.send("\r\n");
                      } catch (e) {
                        l.warn("error sending Keep Alive response: ".concat(e));
                      }
                    }
                  },
                },
                  ...
                  value: function (e, t) {
                    switch (e) {
                      ...
                      case "display_name":
                        ...
                        break;
                      case "extra_headers":
                        this._configuration.extra_headers = t;
                        break;
                      default:
                        return (
                          R.warn(
        ...
        function (e, t, n) {
          ...
          t.exports = (function () {
            function e(t) {
              ...
              if (-1 === n)
                throw (
                  (o.warn("invalid WebSocket URI: ".concat(t)),
                  new TypeError("Invalid argument: ".concat(t)))
                );
              if ("wss" !== n.scheme && "ws" !== n.scheme)
                throw (
                  (o.warn("invalid WebSocket URI scheme: ".concat(n.scheme)),
                  new TypeError("Invalid argument: ".concat(t)))
                );
              (this._sip_uri = "sip:"
                .concat(n.host)
